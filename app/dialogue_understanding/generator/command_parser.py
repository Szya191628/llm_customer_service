...
from app.dialogue_understanding.commands.base import (
    Command,
    get_all_command_classes,
    parse_command_from_text,
)
from app.dialogue_understanding.commands.error_commands import ParseErrorCommand
...
class CommandParser:
    ...
    def _clean_text(self, text: str) -> str:
        ...
        # 移除中文前缀（如 "命令：" "命令:" "Command:"）
        text = re.sub(r'^(?:命令|指令|command)\s*[:：]\s*', '', text, flags=re.IGNORECASE)
