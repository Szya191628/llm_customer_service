...
from app.dialogue_understanding.flow.flow import Flow, FlowsList
from app.shared.yaml_loader import read_yaml_file, read_yaml_files
...
class FlowLoader:
    ...
    def load_from_string(self, yaml_string: str) -> FlowsList:
        ...
        Returns:
            FlowsList实例
        """
        from app.shared.yaml_loader import read_yaml_string
