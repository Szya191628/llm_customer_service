...
from app.shared.constants import DEFAULT_SERVER_PORT
...
def main(args: Optional[list] = None) -> None:
    ...
    try:
        ...
        from app.cli.train import train_command
        from app.cli.run import run_command
        from app.cli.shell import shell_command
        from app.cli.export import export_command
        from app.cli.inspect import inspect_command
