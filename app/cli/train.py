...
def train_command(
    ...
    try:
        # 导入训练模块
        from app.training.trainer import Trainer, TrainerConfig
        from app.shared.config import AtguiguConfig
        ...
        if dry_run:
            ...
            from app.dialogue_understanding.flow import FlowLoader
