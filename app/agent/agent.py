...
from app.agent.actions import register_action, Action
...
from app.core.stores import create_tracker_store, TrackerStore
from app.dialogue_understanding.flow import FlowsList, FlowLoader
...
from app.policies import PolicyEnsemble, FlowPolicy, EnterpriseSearchPolicy
from app.shared.yaml_loader import read_yaml_file
from app.shared.config import AtguiguConfig, LLMConfig
...
class Agent:
    ...
    def load(
        ...
        """
        import tempfile
        from app.training.model_storage import (
        ...
        from app.shared.config import EndpointsConfig
        ...
        if config_path.exists():
            ...
            if config_data:
                ...
                if "retrieval" in config_data:
                    from app.shared.config import RetrievalConfig
        ...
        if llm_config:
            from app.dialogue_understanding.generator import (
                LLMCommandGenerator,
                LLMGeneratorConfig,
            )
        ...
        # 创建策略
        from app.policies import EnterpriseSearchPolicyConfig
        ...
        if nlg_config and nlg_config.rephrase_enabled:
            try:
                from app.nlg import ResponseRephraser, RephraserConfig, TemplateNLG
